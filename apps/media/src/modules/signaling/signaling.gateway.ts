  ...
  implements OnGatewayConnection, OnGatewayDisconnect
{
  ...
  async joinRoom(
    ...
    if (!roomId) {
      return this.reply("error", { message: "roomId is required" }, requestId);
    }
  ...
  async createWebRtcTransport(
    ...
    if (!room) {
      return this.reply("error", { message: "Room not found" }, data.requestId);
    }
  ...
  async produce(
    ...
    return this.reply("produced", { producerId: producer.id }, data.requestId);
  }
